  ...
  return (
    <div className="bg-white rounded-3xl shadow-md hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden flex flex-col h-full group hover:-translate-y-2">
      ...
      <div className="p-6 flex flex-col flex-grow text-left">
        <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 leading-snug group-hover:text-orange-600 transition-colors duration-300">
          {product.title}
        </h3>
        ...
        <div className="mt-auto pt-5 border-t border-gray-200 flex items-center justify-between">
          <Link
            ...
            className="inline-flex items-center gap-2 text-orange-600 font-semibold hover:text-white transition-all duration-300 group/link w-full justify-between px-4 py-2 rounded-xl bg-gradient-to-r from-orange-50 to-amber-50 hover:from-orange-600 hover:to-amber-600"
          >
